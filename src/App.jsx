...
class BooksApp extends React.Component {
  ...
  getBooksByType(type) {
    return this.state.books.filter(book => book.type === type)
  }

  changeBookType(book, type) {
    const newBook = {
      id: book.id,
      title: book.title,
      author: book.author,
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <BookShelf
                  books={this.getBooksByType('Current')}
                  title="Currently Reading"
                  changeBookType={this.changeBookType}
                />
                <BookShelf
                  books={this.getBooksByType('Want')}
                  title="Want to Read"
                  changeBookType={this.changeBookType}
                />
                <BookShelf
                  books={this.getBooksByType('Read')}
                  title="Read"
                  changeBookType={this.changeBookType}
                />
              </div>
